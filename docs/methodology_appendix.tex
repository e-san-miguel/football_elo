...
A team's squad score is the \emph{mean} age-adjusted value across matched players:
\begin{equation}
S_T = \frac{1}{|\mathcal{P}_T|} \sum_{p \in \mathcal{P}_T} \text{adj}(v_p, a_p)
...
The grid search selects $\beta^\star = 0.1$ with pooled Brier 0.5952, versus 0.5954 for pure Elo --- a 0.15\% relative lift, far below the decision gate. Cross-validated lifts are $+0.14\%$ (train 2022, test 2018) and $+0.19\%$ (train 2018, test 2022).

\paragraph{Diagnosis.} The normalized squad score $z_T$ has Pearson correlation of $0.80$ (2018) and $0.79$ (2022) with normalized Elo. Elo already captures the bulk of squad-quality information --- strong teams accumulate high Elo because they have good rosters. The residual squad signal orthogonal to Elo is small and noisy over the 128-match backtest window.
...
Applying the composite rating at $\beta = 0.1$ to current TM squads (players active in the 2023/24 season or later, top 26 by market value per team) yields the tournament-level shifts shown in Table~\ref{tab:composite2026}. France gains the most because its squad is the most talent-dense in the field; Mexico loses ground relative to Portugal, reflecting that Elo was overvaluing Mexico's host-boosted rating.
...
\midrule
Spain     & 2218 & 2255 & 32.0\% & 34.4\% \\
Argentina & 2179 & 2199 & 19.8\% & 18.3\% \\
France    & 2137 & 2181 & 14.6\% & 18.5\% \\
England   & 2084 & 2126 & 6.4\%  & 7.9\%  \\
Brazil    & 2045 & 2077 & 3.5\%  & 4.0\%  \\
Portugal  & 2035 & 2059 & 2.7\%  & 2.9\%  \\
Mexico    & 1912 & 1905 & 2.1\%  & 1.1\%  \\
\bottomrule
\end{tabular}
\caption{Illustrative 2026 WC win probabilities: pure Elo vs composite ($\beta = 0.1$). These outputs are not currently used on the live site.}
